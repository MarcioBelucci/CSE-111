#I added a new test that verifies the pressure conversion from kilopascals to psi.
...
def test_pressure_gain_from_water_height():
    assert pressure_gain_from_water_height(0.0) == approx(0.00, abs=0.001)
...
def test_kilopascals_to_psi():
    assert kilopascals_to_psi(158.7) == approx(23.0, abs=0.1)
    assert kilopascals_to_psi(1481.2) == approx(214.8, abs=0.1)
    assert kilopascals_to_psi(50.0) == approx(7.3, abs=0.1)
    assert kilopascals_to_psi(101.3) == approx(14.7, abs=0.1)
    assert kilopascals_to_psi(310.5) == approx(45.0, abs=0.1)
